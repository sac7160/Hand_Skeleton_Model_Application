...
public class PressureSensorInputController : MonoBehaviour
{
    ...
    */
    ...
    {
        if(data < 20) return Color.white;
        else if(data<40) return Color.yellow;
        else if(data<60) return Color.green;
        else if(data<80) return Color.red;
    ...
    */
    ...
    {
        //fsr csv 파일 읽기
        pressure_data = CSVReader.Read("P000, CNA, Free Motion (on shoulder height), trialSession-0, 120s, merged.csv", "fsr");   
